...
/**
 * This class defines the structure of the 'ПодрядчикиПредписания' table.
 *
 *
 *
...
class ПодрядчикипредписанияTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'ПодрядчикиПредписания';
     ...
     */
    const COL_ID = 'ПодрядчикиПредписания.id';

    /**
     * the column name for the Подрядчик field
     */
    const COL_ПОДРЯДЧИК = 'ПодрядчикиПредписания.Подрядчик';
    ...
    {
        // attributes
        $this->setName('ПодрядчикиПредписания');
    ...
    /**
     * Deletes all rows from the ПодрядчикиПредписания table.
     *
     * @param ConnectionInterface $con the connection to use
