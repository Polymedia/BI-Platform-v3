...
/**
 * This class defines the structure of the 'ТипыРабот' table.
 *
 *
 *
...
class ТипыработTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'ТипыРабот.id';

    /**
     * the column name for the ТипРабот field
     */
    const COL_ТИПРАБОТ = 'ТипыРабот.ТипРабот';

    /**
     * the column name for the ЕдиницыИзмерения field
     */
    const COL_ЕДИНИЦЫИЗМЕРЕНИЯ = 'ТипыРабот.ЕдиницыИзмерения';

    /**
     * the column name for the Отображение field
     */
    const COL_ОТОБРАЖЕНИЕ = 'ТипыРабот.Отображение';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ТипыработTableMap::COL_ID, ТипыработTableMap::COL_ТИПРАБОТ, ТипыработTableMap::COL_ЕДИНИЦЫИЗМЕРЕНИЯ, ТипыработTableMap::COL_ОТОБРАЖЕНИЕ, ),
        self::TYPE_FIELDNAME     => array('id', 'ТипРабот', 'ЕдиницыИзмерения', 'Отображение', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ТипыработTableMap::COL_ID => 0, ТипыработTableMap::COL_ТИПРАБОТ => 1, ТипыработTableMap::COL_ЕДИНИЦЫИЗМЕРЕНИЯ => 2, ТипыработTableMap::COL_ОТОБРАЖЕНИЕ => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'ТипРабот' => 1, 'ЕдиницыИзмерения' => 2, 'Отображение' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('ТипРабот', 'Типработ', 'LONGVARCHAR', true, null, null);
        $this->addColumn('ЕдиницыИзмерения', 'Единицыизмерения', 'LONGVARCHAR', true, null, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ТипыработTableMap::COL_ТИПРАБОТ);
            $criteria->addSelectColumn(ТипыработTableMap::COL_ЕДИНИЦЫИЗМЕРЕНИЯ);
            $criteria->addSelectColumn(ТипыработTableMap::COL_ОТОБРАЖЕНИЕ);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.ТипРабот');
            $criteria->addSelectColumn($alias . '.ЕдиницыИзмерения');
