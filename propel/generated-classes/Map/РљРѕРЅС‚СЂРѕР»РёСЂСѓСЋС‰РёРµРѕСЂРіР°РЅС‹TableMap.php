...
/**
 * This class defines the structure of the 'КонтролирующиеОрганы' table.
 *
 *
 *
...
class КонтролирующиеорганыTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'КонтролирующиеОрганы';
     ...
     */
    const COL_ID = 'КонтролирующиеОрганы.id';

    /**
     * the column name for the КонтролирующийОрган field
     */
    const COL_КОНТРОЛИРУЮЩИЙОРГАН = 'КонтролирующиеОрганы.КонтролирующийОрган';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(КонтролирующиеорганыTableMap::COL_ID, КонтролирующиеорганыTableMap::COL_КОНТРОЛИРУЮЩИЙОРГАН, ),
        self::TYPE_FIELDNAME     => array('id', 'КонтролирующийОрган', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(КонтролирующиеорганыTableMap::COL_ID => 0, КонтролирующиеорганыTableMap::COL_КОНТРОЛИРУЮЩИЙОРГАН => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'КонтролирующийОрган' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        // attributes
        $this->setName('КонтролирующиеОрганы');
        ...
        $this->addColumn('КонтролирующийОрган', 'Контролирующийорган', 'LONGVARCHAR', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(КонтролирующиеорганыTableMap::COL_КОНТРОЛИРУЮЩИЙОРГАН);
        } else {
