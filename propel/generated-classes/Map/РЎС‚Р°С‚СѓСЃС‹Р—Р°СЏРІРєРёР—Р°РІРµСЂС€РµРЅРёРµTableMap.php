...
/**
 * This class defines the structure of the 'Статусы_заявки_завершение' table.
 *
 *
 *
...
class СтатусыЗаявкиЗавершениеTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'Статусы_заявки_завершение';
     ...
     */
    const COL_ID = 'Статусы_заявки_завершение.id';

    /**
     * the column name for the Статус_завершения field
     */
    const COL_СТАТУС_ЗАВЕРШЕНИЯ = 'Статусы_заявки_завершение.Статус_завершения';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(СтатусыЗаявкиЗавершениеTableMap::COL_ID, СтатусыЗаявкиЗавершениеTableMap::COL_СТАТУС_ЗАВЕРШЕНИЯ, ),
        self::TYPE_FIELDNAME     => array('id', 'Статус_завершения', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(СтатусыЗаявкиЗавершениеTableMap::COL_ID => 0, СтатусыЗаявкиЗавершениеTableMap::COL_СТАТУС_ЗАВЕРШЕНИЯ => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'Статус_завершения' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        // attributes
        $this->setName('Статусы_заявки_завершение');
        ...
        $this->addColumn('Статус_завершения', 'статусзавершения', 'LONGVARCHAR', true, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(СтатусыЗаявкиЗавершениеTableMap::COL_СТАТУС_ЗАВЕРШЕНИЯ);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.Статус_завершения');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(СтатусыЗаявкиЗавершениеTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(СтатусыЗаявкиЗавершениеTableMap::COL_ID) && $criteria->keyContainsValue(СтатусыЗаявкиЗавершениеTableMap::COL_ID) ) {
