...
/**
 * This class defines the structure of the 'ДатыОбновленийДашбордов' table.
 *
 *
 *
...
class ДатыобновленийдашбордовTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'ДатыОбновленийДашбордов';
     ...
     */
    const COL_ID = 'ДатыОбновленийДашбордов.id';

    /**
     * the column name for the Дашборд field
     */
    const COL_ДАШБОРД = 'ДатыОбновленийДашбордов.Дашборд';

    /**
     * the column name for the Проект field
     */
    const COL_ПРОЕКТ = 'ДатыОбновленийДашбордов.Проект';

    /**
     * the column name for the Дата field
     */
    const COL_ДАТА = 'ДатыОбновленийДашбордов.Дата';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ДатыобновленийдашбордовTableMap::COL_ID, ДатыобновленийдашбордовTableMap::COL_ДАШБОРД, ДатыобновленийдашбордовTableMap::COL_ПРОЕКТ, ДатыобновленийдашбордовTableMap::COL_ДАТА, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ДатыобновленийдашбордовTableMap::COL_ID => 0, ДатыобновленийдашбордовTableMap::COL_ДАШБОРД => 1, ДатыобновленийдашбордовTableMap::COL_ПРОЕКТ => 2, ДатыобновленийдашбордовTableMap::COL_ДАТА => 3, ),
    ...
    {
        // attributes
        $this->setName('ДатыОбновленийДашбордов');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ДатыобновленийдашбордовTableMap::COL_ДАШБОРД);
            $criteria->addSelectColumn(ДатыобновленийдашбордовTableMap::COL_ПРОЕКТ);
