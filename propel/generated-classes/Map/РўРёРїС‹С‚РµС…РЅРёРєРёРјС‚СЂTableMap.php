...
/**
 * This class defines the structure of the 'ТипыТехникиМТР' table.
 *
 *
 *
...
class ТипытехникимтрTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'ТипыТехникиМТР';
     ...
     */
    const COL_ID = 'ТипыТехникиМТР.id';

    /**
     * the column name for the ТипТехники field
     */
    const COL_ТИПТЕХНИКИ = 'ТипыТехникиМТР.ТипТехники';

    /**
     * the column name for the ОтображаемыйТипТехники field
     */
    const COL_ОТОБРАЖАЕМЫЙТИПТЕХНИКИ = 'ТипыТехникиМТР.ОтображаемыйТипТехники';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ТипытехникимтрTableMap::COL_ID, ТипытехникимтрTableMap::COL_ТИПТЕХНИКИ, ТипытехникимтрTableMap::COL_ОТОБРАЖАЕМЫЙТИПТЕХНИКИ, ),
        self::TYPE_FIELDNAME     => array('id', 'ТипТехники', 'ОтображаемыйТипТехники', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ТипытехникимтрTableMap::COL_ID => 0, ТипытехникимтрTableMap::COL_ТИПТЕХНИКИ => 1, ТипытехникимтрTableMap::COL_ОТОБРАЖАЕМЫЙТИПТЕХНИКИ => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'ТипТехники' => 1, 'ОтображаемыйТипТехники' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('ОтображаемыйТипТехники', 'Отображаемыйтиптехники', 'INTEGER', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ТипытехникимтрTableMap::COL_ТИПТЕХНИКИ);
            $criteria->addSelectColumn(ТипытехникимтрTableMap::COL_ОТОБРАЖАЕМЫЙТИПТЕХНИКИ);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.ТипТехники');
            $criteria->addSelectColumn($alias . '.ОтображаемыйТипТехники');
        }
    }
