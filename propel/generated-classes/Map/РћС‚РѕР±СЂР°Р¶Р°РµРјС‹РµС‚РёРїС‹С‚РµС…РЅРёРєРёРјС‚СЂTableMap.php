...
/**
 * This class defines the structure of the 'ОтображаемыеТипыТехникиМТР' table.
 *
 *
 *
...
class ОтображаемыетипытехникимтрTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'ОтображаемыеТипыТехникиМТР';
     ...
     */
    const COL_ID = 'ОтображаемыеТипыТехникиМТР.id';

    /**
     * the column name for the ОтображаемыйТипТехники field
     */
    const COL_ОТОБРАЖАЕМЫЙТИПТЕХНИКИ = 'ОтображаемыеТипыТехникиМТР.ОтображаемыйТипТехники';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ОтображаемыетипытехникимтрTableMap::COL_ID, ОтображаемыетипытехникимтрTableMap::COL_ОТОБРАЖАЕМЫЙТИПТЕХНИКИ, ),
        self::TYPE_FIELDNAME     => array('id', 'ОтображаемыйТипТехники', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ОтображаемыетипытехникимтрTableMap::COL_ID => 0, ОтображаемыетипытехникимтрTableMap::COL_ОТОБРАЖАЕМЫЙТИПТЕХНИКИ => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'ОтображаемыйТипТехники' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        // attributes
        $this->setName('ОтображаемыеТипыТехникиМТР');
        ...
        $this->addColumn('ОтображаемыйТипТехники', 'Отображаемыйтиптехники', 'LONGVARCHAR', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ОтображаемыетипытехникимтрTableMap::COL_ОТОБРАЖАЕМЫЙТИПТЕХНИКИ);
        } else {
