...
/**
 * Base class that represents a row from the 'ТипыРабот' table.
 *
 * 
 *
...
abstract class Типыработ implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the единицыизмерения field.
     * 
     * @var        string
     */
    protected $единицыизмерения;
    ...
    /**
     * Get the [единицыизмерения] column value.
     * 
     * @return string
     */
    public function getЕдиницыизмерения()
    {
        return $this->единицыизмерения;
    }
    ...
    public function setТипработ($v)
    {
        ...
        if ($this->типработ !== $v) {
            $this->типработ = $v;
            $this->modifiedColumns[ТипыработTableMap::COL_ТИПРАБОТ] = true;
        }
    ...
    /**
     * Set the value of [единицыизмерения] column.
     * 
     * @param string $v new value
     * @return $this|\Типыработ The current object (for fluent API support)
     */
    public function setЕдиницыизмерения($v)
    {
        ...
        if ($this->единицыизмерения !== $v) {
            $this->единицыизмерения = $v;
            $this->modifiedColumns[ТипыработTableMap::COL_ЕДИНИЦЫИЗМЕРЕНИЯ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->типработ = (null !== $col) ? (string) $col : null;
            ...
            $this->единицыизмерения = (null !== $col) ? (string) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ТипыработTableMap::COL_ТИПРАБОТ)) {
            $modifiedColumns[':p' . $index++]  = 'ТипРабот';
        }
        if ($this->isColumnModified(ТипыработTableMap::COL_ЕДИНИЦЫИЗМЕРЕНИЯ)) {
            $modifiedColumns[':p' . $index++]  = 'ЕдиницыИзмерения';
        }
        ...
        $sql = sprintf(
            'INSERT INTO ТипыРабот (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':                        
                        ...
                        break;
                    case 'ТипРабот':                        
                        $stmt->bindValue($identifier, $this->типработ, PDO::PARAM_STR);
                        break;
                    case 'ЕдиницыИзмерения':                        
                        $stmt->bindValue($identifier, $this->единицыизмерения, PDO::PARAM_STR);
                        break;
                    case 'Отображение':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ТипыработTableMap::COL_ТИПРАБОТ)) {
            $criteria->add(ТипыработTableMap::COL_ТИПРАБОТ, $this->типработ);
        }
        if ($this->isColumnModified(ТипыработTableMap::COL_ЕДИНИЦЫИЗМЕРЕНИЯ)) {
            $criteria->add(ТипыработTableMap::COL_ЕДИНИЦЫИЗМЕРЕНИЯ, $this->единицыизмерения);
        }
        if ($this->isColumnModified(ТипыработTableMap::COL_ОТОБРАЖЕНИЕ)) {
