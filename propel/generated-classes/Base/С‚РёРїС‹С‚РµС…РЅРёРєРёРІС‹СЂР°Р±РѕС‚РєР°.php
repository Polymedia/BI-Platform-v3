...
/**
 * Base class that represents a row from the 'Типы_техники_выработка' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class типытехникивыработка implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\типытехникивыработкаTableMap';
    ...
    /**
     * Initializes internal state of Base\типытехникивыработка object.
     */
    ...
    /**
     * Compares this with another <code>типытехникивыработка</code> instance.  If
     * <code>obj</code> is an instance of <code>типытехникивыработка</code>, delegates to
     * <code>equals(типытехникивыработка)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|типытехникивыработка The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[типытехникивыработкаTableMap::COL_ID] = true;
        }
    ...
    public function setтиптехники($v)
    {
        ...
        if ($this->тип_техники !== $v) {
            $this->тип_техники = $v;
            $this->modifiedColumns[типытехникивыработкаTableMap::COL_ТИП_ТЕХНИКИ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : типытехникивыработкаTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : типытехникивыработкаTableMap::translateFieldName('типтехники', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = типытехникивыработкаTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\типытехникивыработка'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildтипытехникивыработкаQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see типытехникивыработка::setDeleted()
     * @see типытехникивыработка::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildтипытехникивыработкаQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                типытехникивыработкаTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(типытехникивыработкаTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(типытехникивыработкаTableMap::COL_ТИП_ТЕХНИКИ)) {
            $modifiedColumns[':p' . $index++]  = 'Тип_техники';
        }

        $sql = sprintf(
            'INSERT INTO Типы_техники_выработка (%s) VALUES (%s)',
    ...
    {
        $pos = типытехникивыработкаTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['типытехникивыработка'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['типытехникивыработка'][$this->hashCode()] = true;
        $keys = типытехникивыработкаTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\типытехникивыработка
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(типытехникивыработкаTableMap::COL_ID)) {
            $criteria->add(типытехникивыработкаTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(типытехникивыработкаTableMap::COL_ТИП_ТЕХНИКИ)) {
            $criteria->add(типытехникивыработкаTableMap::COL_ТИП_ТЕХНИКИ, $this->тип_техники);
        }
    ...
    {
        $criteria = ChildтипытехникивыработкаQuery::create();
        $criteria->add(типытехникивыработкаTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \типытехникивыработка (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \типытехникивыработка Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Childтипытехникивыработка is new, it will return
        ...
        if (null === $this->collвыработкаs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collвыработкаs) {
                ...
                $collвыработкаs = ChildвыработкаQuery::create(null, $criteria)
                    ->filterByтипытехникивыработка($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|Childтипытехникивыработка The current object (for fluent API support)
     */
    public function setвыработкаs(Collection $�ыработкаs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�ыработкаsToDelete as $�ыработкаRemoved) {
            $�ыработкаRemoved->setтипытехникивыработка(null);
        }
    ...
    protected function doAddвыработка(Childвыработка $�ыработка)
    {
        ...
        $�ыработка->setтипытехникивыработка($this);
    }
    ...
    public function removeвыработка(Childвыработка $�ыработка)
    {
        if ($this->getвыработкаs()->contains($�ыработка)) {
            ...
            $�ыработка->setтипытехникивыработка(null);
        }
     ...
     * Otherwise if this типытехникивыработка is new, it will return
     * an empty collection; or if this типытехникивыработка has previously
     * been saved, it will retrieve related выработкаs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in типытехникивыработка.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(типытехникивыработкаTableMap::DEFAULT_STRING_FORMAT);
    }
