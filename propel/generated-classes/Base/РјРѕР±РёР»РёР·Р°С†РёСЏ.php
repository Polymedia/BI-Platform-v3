...
abstract class мобилизация implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the остаток_к_доставке field.
     * 
     * @var        int
     */
    protected $остаток_к_доставке;

    /**
     * The value for the промежуточный_пункт_количество field.
     * 
     * @var        int
     */
    protected $промежуточный_пункт_количество;
    ...
    /**
     * Get the [остаток_к_доставке] column value.
     * 
     * @return int
     */
    public function getостатоккдоставке()
    {
        return $this->остаток_к_доставке;
    }

    /**
     * Get the [промежуточный_пункт_количество] column value.
     * 
     * @return int
     */
    public function getпромежуточныйпунктколичество()
    {
        return $this->промежуточный_пункт_количество;
    }
    ...
    public function setтиптехники($v)
    {
        ...
        if ($this->тип_техники !== $v) {
            $this->тип_техники = $v;
            $this->modifiedColumns[мобилизацияTableMap::COL_ТИП_ТЕХНИКИ] = true;
        }
    ...
    public function setпланотгрузкаколичество($v)
    {
        ...
        if ($this->план_отгрузка_количество !== $v) {
            ...
            $this->modifiedColumns[мобилизацияTableMap::COL_ПЛАН_ОТГРУЗКА_КОЛИЧЕСТВО] = true;
        }
    ...
    public function setфактотгрузкаколичество($v)
    {
        ...
        if ($this->факт_отгрузка_количество !== $v) {
            ...
            $this->modifiedColumns[мобилизацияTableMap::COL_ФАКТ_ОТГРУЗКА_КОЛИЧЕСТВО] = true;
        }
    ...
    public function setпландоставкаколичество($v)
    {
        ...
        if ($this->план_доставка_количество !== $v) {
            ...
            $this->modifiedColumns[мобилизацияTableMap::COL_ПЛАН_ДОСТАВКА_КОЛИЧЕСТВО] = true;
        }
    ...
    public function setфактдоставкаколичество($v)
    {
        ...
        if ($this->факт_доставка_количество !== $v) {
            ...
            $this->modifiedColumns[мобилизацияTableMap::COL_ФАКТ_ДОСТАВКА_КОЛИЧЕСТВО] = true;
        }
    ...
    /**
     * Set the value of [остаток_к_доставке] column.
     * 
     * @param int $v new value
     * @return $this|\мобилизация The current object (for fluent API support)
     */
    public function setостатоккдоставке($v)
    {
        ...
        if ($this->остаток_к_доставке !== $v) {
            $this->остаток_к_доставке = $v;
            $this->modifiedColumns[мобилизацияTableMap::COL_ОСТАТОК_К_ДОСТАВКЕ] = true;
        }
    ...
    /**
     * Set the value of [промежуточный_пункт_количество] column.
     * 
     * @param int $v new value
     * @return $this|\мобилизация The current object (for fluent API support)
     */
    public function setпромежуточныйпунктколичество($v)
    {
        ...
        if ($this->промежуточный_пункт_количество !== $v) {
            $this->промежуточный_пункт_количество = $v;
            $this->modifiedColumns[мобилизацияTableMap::COL_ПРОМЕЖУТОЧНЫЙ_ПУНКТ_КОЛИЧЕСТВО] = true;
        }
    ...
    public function setдатаотчёта($v)
    {
        ...
        if ($this->дата_отчёта !== null || $dt !== null) {
            if ($this->дата_отчёта === null || $dt === null || $dt->format("Y-m-d") !== $this->дата_отчёта->format("Y-m-d")) {
                ...
                $this->modifiedColumns[мобилизацияTableMap::COL_ДАТА_ОТЧЁТА] = true;
            }
    ...
    public function setучастокработ($v)
    {
        ...
        if ($this->участок_работ !== $v) {
            ...
            $this->modifiedColumns[мобилизацияTableMap::COL_УЧАСТОК_РАБОТ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->остаток_к_доставке = (null !== $col) ? (int) $col : null;
            ...
            $this->промежуточный_пункт_количество = (null !== $col) ? (int) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(мобилизацияTableMap::COL_ТИП_ТЕХНИКИ)) {
            $modifiedColumns[':p' . $index++]  = 'Тип_техники';
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ПЛАН_ОТГРУЗКА_КОЛИЧЕСТВО)) {
            $modifiedColumns[':p' . $index++]  = 'План_отгрузка_количество';
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ФАКТ_ОТГРУЗКА_КОЛИЧЕСТВО)) {
            $modifiedColumns[':p' . $index++]  = 'Факт_отгрузка_количество';
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ПЛАН_ДОСТАВКА_КОЛИЧЕСТВО)) {
            $modifiedColumns[':p' . $index++]  = 'План_доставка_количество';
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ФАКТ_ДОСТАВКА_КОЛИЧЕСТВО)) {
        ...
        if ($this->isColumnModified(мобилизацияTableMap::COL_ОСТАТОК_К_ДОСТАВКЕ)) {
            $modifiedColumns[':p' . $index++]  = 'Остаток_к_доставке';
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ПРОМЕЖУТОЧНЫЙ_ПУНКТ_КОЛИЧЕСТВО)) {
            $modifiedColumns[':p' . $index++]  = 'Промежуточный_пункт_количество';
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ПРОЕКТ)) {
            $modifiedColumns[':p' . $index++]  = 'Проект';
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ДАТА_ОТЧЁТА)) {
            $modifiedColumns[':p' . $index++]  = 'Дата_отчёта';
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_УЧАСТОК_РАБОТ)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'Аренда':                        
                        ...
                        break;
                    case 'Остаток_к_доставке':                        
                        $stmt->bindValue($identifier, $this->остаток_к_доставке, PDO::PARAM_INT);
                        break;
                    case 'Промежуточный_пункт_количество':                        
                        $stmt->bindValue($identifier, $this->промежуточный_пункт_количество, PDO::PARAM_INT);
                        break;
                    case 'Проект':                        
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(мобилизацияTableMap::COL_ТИП_ТЕХНИКИ)) {
            $criteria->add(мобилизацияTableMap::COL_ТИП_ТЕХНИКИ, $this->тип_техники);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ПЛАН_ОТГРУЗКА_КОЛИЧЕСТВО)) {
            $criteria->add(мобилизацияTableMap::COL_ПЛАН_ОТГРУЗКА_КОЛИЧЕСТВО, $this->план_отгрузка_количество);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ФАКТ_ОТГРУЗКА_КОЛИЧЕСТВО)) {
            $criteria->add(мобилизацияTableMap::COL_ФАКТ_ОТГРУЗКА_КОЛИЧЕСТВО, $this->факт_отгрузка_количество);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ПЛАН_ДОСТАВКА_КОЛИЧЕСТВО)) {
            $criteria->add(мобилизацияTableMap::COL_ПЛАН_ДОСТАВКА_КОЛИЧЕСТВО, $this->план_доставка_количество);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ФАКТ_ДОСТАВКА_КОЛИЧЕСТВО)) {
            $criteria->add(мобилизацияTableMap::COL_ФАКТ_ДОСТАВКА_КОЛИЧЕСТВО, $this->факт_доставка_количество);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_АРЕНДА)) {
            $criteria->add(мобилизацияTableMap::COL_АРЕНДА, $this->аренда);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ОСТАТОК_К_ДОСТАВКЕ)) {
            $criteria->add(мобилизацияTableMap::COL_ОСТАТОК_К_ДОСТАВКЕ, $this->остаток_к_доставке);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ПРОМЕЖУТОЧНЫЙ_ПУНКТ_КОЛИЧЕСТВО)) {
            $criteria->add(мобилизацияTableMap::COL_ПРОМЕЖУТОЧНЫЙ_ПУНКТ_КОЛИЧЕСТВО, $this->промежуточный_пункт_количество);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ПРОЕКТ)) {
            $criteria->add(мобилизацияTableMap::COL_ПРОЕКТ, $this->проект);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_ДАТА_ОТЧЁТА)) {
            $criteria->add(мобилизацияTableMap::COL_ДАТА_ОТЧЁТА, $this->дата_отчёта);
        }
        if ($this->isColumnModified(мобилизацияTableMap::COL_УЧАСТОК_РАБОТ)) {
            $criteria->add(мобилизацияTableMap::COL_УЧАСТОК_РАБОТ, $this->участок_работ);
        }
    ...
    {
        $criteria = ChildмобилизацияQuery::create();
        $criteria->add(мобилизацияTableMap::COL_ID, $this->id);
    ...
    public function getКалендарь(ConnectionInterface $con = null)
    {
        if ($this->aКалендарь === null && (($this->дата_отчёта !== "" && $this->дата_отчёта !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aКалендарь->addмобилизацияs($this);
             */
        }
    ...
    public function getПроекты(ConnectionInterface $con = null)
    {
        if ($this->aПроекты === null && ($this->проект !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aПроекты->addмобилизацияs($this);
             */
        }
    ...
    public function getтипытехникимобилизация(ConnectionInterface $con = null)
    {
        if ($this->aтипытехникимобилизация === null && ($this->тип_техники !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aтипытехникимобилизация->addмобилизацияs($this);
             */
        }
    ...
    public function getучасткиработмобилизация(ConnectionInterface $con = null)
    {
        if ($this->aучасткиработмобилизация === null && ($this->участок_работ !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aучасткиработмобилизация->addмобилизацияs($this);
             */
        }
