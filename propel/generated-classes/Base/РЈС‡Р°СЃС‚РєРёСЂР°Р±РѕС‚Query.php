...
/**
 * Base class that represents a query for the 'УчасткиРабот' table.
 *
 * 
 *
 * @method     ChildУчасткиработQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildУчасткиработQuery orderByУчастокработ($order = Criteria::ASC) Order by the УчастокРабот column
 ...
 * @method     ChildУчасткиработQuery groupByУчастокработ() Group by the УчастокРабот column
 ...
 * @method     ChildУчасткиработ findOneByУчастокработ(string $УчастокРабот) Return the first ChildУчасткиработ filtered by the УчастокРабот column
 ...
 * @method     ChildУчасткиработ requireOneByУчастокработ(string $УчастокРабот) Return the first ChildУчасткиработ filtered by the УчастокРабот column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildУчасткиработ[]|ObjectCollection findByУчастокработ(string $УчастокРабот) Return ChildУчасткиработ objects filtered by the УчастокРабот column
...
abstract class УчасткиработQuery extends ModelCriteria
{
    ...
    public function filterByУчастокработ($�частокработ = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(УчасткиработTableMap::COL_УЧАСТОКРАБОТ, $�частокработ, $comparison);
    }
    ...
    {
        if ($�часткиработ) {
            throw new LogicException('Участкиработ object has no primary key');
