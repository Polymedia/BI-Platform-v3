...
/**
 * Base class that represents a row from the 'Типы_техники_мобилизация' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class типытехникимобилизация implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\типытехникимобилизацияTableMap';
    ...
    /**
     * Initializes internal state of Base\типытехникимобилизация object.
     */
    ...
    /**
     * Compares this with another <code>типытехникимобилизация</code> instance.  If
     * <code>obj</code> is an instance of <code>типытехникимобилизация</code>, delegates to
     * <code>equals(типытехникимобилизация)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|типытехникимобилизация The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[типытехникимобилизацияTableMap::COL_ID] = true;
        }
    ...
    public function setтиптехники($v)
    {
        ...
        if ($this->тип_техники !== $v) {
            $this->тип_техники = $v;
            $this->modifiedColumns[типытехникимобилизацияTableMap::COL_ТИП_ТЕХНИКИ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : типытехникимобилизацияTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : типытехникимобилизацияTableMap::translateFieldName('типтехники', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = типытехникимобилизацияTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\типытехникимобилизация'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildтипытехникимобилизацияQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see типытехникимобилизация::setDeleted()
     * @see типытехникимобилизация::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildтипытехникимобилизацияQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                типытехникимобилизацияTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(типытехникимобилизацияTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(типытехникимобилизацияTableMap::COL_ТИП_ТЕХНИКИ)) {
            $modifiedColumns[':p' . $index++]  = 'Тип_техники';
        }

        $sql = sprintf(
            'INSERT INTO Типы_техники_мобилизация (%s) VALUES (%s)',
    ...
    {
        $pos = типытехникимобилизацияTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['типытехникимобилизация'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['типытехникимобилизация'][$this->hashCode()] = true;
        $keys = типытехникимобилизацияTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\типытехникимобилизация
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(типытехникимобилизацияTableMap::COL_ID)) {
            $criteria->add(типытехникимобилизацияTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(типытехникимобилизацияTableMap::COL_ТИП_ТЕХНИКИ)) {
            $criteria->add(типытехникимобилизацияTableMap::COL_ТИП_ТЕХНИКИ, $this->тип_техники);
        }
    ...
    {
        $criteria = ChildтипытехникимобилизацияQuery::create();
        $criteria->add(типытехникимобилизацияTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \типытехникимобилизация (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \типытехникимобилизация Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Childтипытехникимобилизация is new, it will return
        ...
        if (null === $this->collмобилизацияs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collмобилизацияs) {
                ...
                $collмобилизацияs = ChildмобилизацияQuery::create(null, $criteria)
                    ->filterByтипытехникимобилизация($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|Childтипытехникимобилизация The current object (for fluent API support)
     */
    public function setмобилизацияs(Collection $�обилизацияs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�обилизацияsToDelete as $�обилизацияRemoved) {
            $�обилизацияRemoved->setтипытехникимобилизация(null);
        }
    ...
    public function removeмобилизация(Childмобилизация $�обилизация)
    {
        if ($this->getмобилизацияs()->contains($�обилизация)) {
            ...
            $�обилизация->setтипытехникимобилизация(null);
        }
     ...
     * Otherwise if this типытехникимобилизация is new, it will return
     * an empty collection; or if this типытехникимобилизация has previously
     * been saved, it will retrieve related мобилизацияs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in типытехникимобилизация.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function setмобилизацияпомесяцамs(Collection $�обилизацияпомесяцамs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�обилизацияпомесяцамsToDelete as $�обилизацияпомесяцамRemoved) {
            $�обилизацияпомесяцамRemoved->setтипытехникимобилизация(null);
        }
    ...
    protected function doAddмобилизацияпомесяцам(Childмобилизацияпомесяцам $�обилизацияпомесяцам)
    {
        ...
        $�обилизацияпомесяцам->setтипытехникимобилизация($this);
    }
    ...
    public function removeмобилизацияпомесяцам(Childмобилизацияпомесяцам $�обилизацияпомесяцам)
    {
        if ($this->getмобилизацияпомесяцамs()->contains($�обилизацияпомесяцам)) {
            ...
            $�обилизацияпомесяцам->setтипытехникимобилизация(null);
        }
    ...
    {
        return (string) $this->exportTo(типытехникимобилизацияTableMap::DEFAULT_STRING_FORMAT);
    }
