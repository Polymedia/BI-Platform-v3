...
/**
 * Base class that represents a row from the 'Типы_замечаний' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class ТипыЗамечаний implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ТипыЗамечанийTableMap';
    ...
    /**
     * Initializes internal state of Base\ТипыЗамечаний object.
     */
    ...
    /**
     * Compares this with another <code>ТипыЗамечаний</code> instance.  If
     * <code>obj</code> is an instance of <code>ТипыЗамечаний</code>, delegates to
     * <code>equals(ТипыЗамечаний)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ТипыЗамечаний The current object, for fluid interface
     */
     ...
     * @return $this|\ТипыЗамечаний The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ТипыЗамечанийTableMap::COL_ID] = true;
        }
    ...
    public function setтипзамечания($v)
    {
        ...
        if ($this->тип_замечания !== $v) {
            ...
            $this->modifiedColumns[ТипыЗамечанийTableMap::COL_ТИП_ЗАМЕЧАНИЯ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ТипыЗамечанийTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ТипыЗамечанийTableMap::translateFieldName('типзамечания', TableMap::TYPE_PHPNAME, $indexType)];
            $this->тип_замечания = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = ТипыЗамечанийTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ТипыЗамечаний'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildТипыЗамечанийQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ТипыЗамечаний::setDeleted()
     * @see ТипыЗамечаний::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildТипыЗамечанийQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ТипыЗамечанийTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ТипыЗамечанийTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ТипыЗамечанийTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ТипыЗамечанийTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ТипыЗамечанийTableMap::COL_ТИП_ЗАМЕЧАНИЯ)) {
            $modifiedColumns[':p' . $index++]  = 'Тип_замечания';
        }

        $sql = sprintf(
            'INSERT INTO Типы_замечаний (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':                        
                        ...
                        break;
                    case 'Тип_замечания':                        
                        $stmt->bindValue($identifier, $this->тип_замечания, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = ТипыЗамечанийTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ТипыЗамечаний'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ТипыЗамечаний'][$this->hashCode()] = true;
        $keys = ТипыЗамечанийTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getтипзамечания(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setтипзамечания($arr[$keys[1]]);
        }
    }
    ...
    {
        $criteria = new Criteria(ТипыЗамечанийTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ТипыЗамечанийTableMap::COL_ID)) {
            $criteria->add(ТипыЗамечанийTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ТипыЗамечанийTableMap::COL_ТИП_ЗАМЕЧАНИЯ)) {
            $criteria->add(ТипыЗамечанийTableMap::COL_ТИП_ЗАМЕЧАНИЯ, $this->тип_замечания);
        }
    ...
    {
        $criteria = ChildТипыЗамечанийQuery::create();
        $criteria->add(ТипыЗамечанийTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ТипыЗамечаний (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ТипыЗамечаний Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildТипыЗамечаний is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildТипыЗамечаний The current object (for fluent API support)
     */
    public function setПредписанияs(Collection $�редписанияs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�редписанияsToDelete as $�редписанияRemoved) {
            $�редписанияRemoved->setТипыЗамечаний(null);
        }
    ...
    protected function doAddПредписания(ChildПредписания $�редписания)
    {
        ...
        $�редписания->setТипыЗамечаний($this);
    }
    ...
    public function removeПредписания(ChildПредписания $�редписания)
    {
        if ($this->getПредписанияs()->contains($�редписания)) {
            ...
            $�редписания->setТипыЗамечаний(null);
        }
     ...
     * Otherwise if this ТипыЗамечаний is new, it will return
     * an empty collection; or if this ТипыЗамечаний has previously
     * been saved, it will retrieve related Предписанияs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ТипыЗамечаний.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ТипыЗамечанийTableMap::DEFAULT_STRING_FORMAT);
    }
