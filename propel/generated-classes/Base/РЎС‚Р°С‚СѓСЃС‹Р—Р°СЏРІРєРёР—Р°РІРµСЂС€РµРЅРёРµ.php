...
/**
 * Base class that represents a row from the 'Статусы_заявки_завершение' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class СтатусыЗаявкиЗавершение implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\СтатусыЗаявкиЗавершениеTableMap';
    ...
    /**
     * The value for the статус_завершения field.
     * 
     * @var        string
     */
    protected $статус_завершения;
    ...
    /**
     * Initializes internal state of Base\СтатусыЗаявкиЗавершение object.
     */
    ...
    /**
     * Compares this with another <code>СтатусыЗаявкиЗавершение</code> instance.  If
     * <code>obj</code> is an instance of <code>СтатусыЗаявкиЗавершение</code>, delegates to
     * <code>equals(СтатусыЗаявкиЗавершение)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|СтатусыЗаявкиЗавершение The current object, for fluid interface
     */
    ...
    /**
     * Get the [статус_завершения] column value.
     * 
     * @return string
     */
    public function getстатусзавершения()
    {
        return $this->статус_завершения;
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[СтатусыЗаявкиЗавершениеTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [статус_завершения] column.
     * 
     * @param string $v new value
     * @return $this|\СтатусыЗаявкиЗавершение The current object (for fluent API support)
     */
    public function setстатусзавершения($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->статус_завершения !== $v) {
            $this->статус_завершения = $v;
            $this->modifiedColumns[СтатусыЗаявкиЗавершениеTableMap::COL_СТАТУС_ЗАВЕРШЕНИЯ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : СтатусыЗаявкиЗавершениеTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : СтатусыЗаявкиЗавершениеTableMap::translateFieldName('статусзавершения', TableMap::TYPE_PHPNAME, $indexType)];
            $this->статус_завершения = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = СтатусыЗаявкиЗавершениеTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\СтатусыЗаявкиЗавершение'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildСтатусыЗаявкиЗавершениеQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see СтатусыЗаявкиЗавершение::setDeleted()
     * @see СтатусыЗаявкиЗавершение::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildСтатусыЗаявкиЗавершениеQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                СтатусыЗаявкиЗавершениеTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[СтатусыЗаявкиЗавершениеTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . СтатусыЗаявкиЗавершениеTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(СтатусыЗаявкиЗавершениеTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(СтатусыЗаявкиЗавершениеTableMap::COL_СТАТУС_ЗАВЕРШЕНИЯ)) {
            $modifiedColumns[':p' . $index++]  = 'Статус_завершения';
        }

        $sql = sprintf(
            'INSERT INTO Статусы_заявки_завершение (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':                        
                        ...
                        break;
                    case 'Статус_завершения':                        
                        $stmt->bindValue($identifier, $this->статус_завершения, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = СтатусыЗаявкиЗавершениеTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getстатусзавершения();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['СтатусыЗаявкиЗавершение'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['СтатусыЗаявкиЗавершение'][$this->hashCode()] = true;
        $keys = СтатусыЗаявкиЗавершениеTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getстатусзавершения(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\СтатусыЗаявкиЗавершение
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setстатусзавершения($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setстатусзавершения($arr[$keys[1]]);
        }
    }
    ...
    {
        $criteria = new Criteria(СтатусыЗаявкиЗавершениеTableMap::DATABASE_NAME);

        if ($this->isColumnModified(СтатусыЗаявкиЗавершениеTableMap::COL_ID)) {
            $criteria->add(СтатусыЗаявкиЗавершениеTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(СтатусыЗаявкиЗавершениеTableMap::COL_СТАТУС_ЗАВЕРШЕНИЯ)) {
            $criteria->add(СтатусыЗаявкиЗавершениеTableMap::COL_СТАТУС_ЗАВЕРШЕНИЯ, $this->статус_завершения);
        }
    ...
    {
        $criteria = ChildСтатусыЗаявкиЗавершениеQuery::create();
        $criteria->add(СтатусыЗаявкиЗавершениеTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \СтатусыЗаявкиЗавершение (or compatible) type.
    ...
    {
        $copyObj->setстатусзавершения($this->getстатусзавершения());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \СтатусыЗаявкиЗавершение Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildСтатусыЗаявкиЗавершение is new, it will return
        ...
        if (null === $this->collПредписанияs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collПредписанияs) {
                ...
                $collПредписанияs = ChildПредписанияQuery::create(null, $criteria)
                    ->filterByСтатусыЗаявкиЗавершение($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildСтатусыЗаявкиЗавершение The current object (for fluent API support)
     */
    public function setПредписанияs(Collection $�редписанияs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�редписанияsToDelete as $�редписанияRemoved) {
            $�редписанияRemoved->setСтатусыЗаявкиЗавершение(null);
        }
    ...
    protected function doAddПредписания(ChildПредписания $�редписания)
    {
        ...
        $�редписания->setСтатусыЗаявкиЗавершение($this);
    }
    ...
    public function removeПредписания(ChildПредписания $�редписания)
    {
        if ($this->getПредписанияs()->contains($�редписания)) {
            ...
            $�редписания->setСтатусыЗаявкиЗавершение(null);
        }
     ...
     * Otherwise if this СтатусыЗаявкиЗавершение is new, it will return
     * an empty collection; or if this СтатусыЗаявкиЗавершение has previously
     * been saved, it will retrieve related Предписанияs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in СтатусыЗаявкиЗавершение.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(СтатусыЗаявкиЗавершениеTableMap::DEFAULT_STRING_FORMAT);
    }
