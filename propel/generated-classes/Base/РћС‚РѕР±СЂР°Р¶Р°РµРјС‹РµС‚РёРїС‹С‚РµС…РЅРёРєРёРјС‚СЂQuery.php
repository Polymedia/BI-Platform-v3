...
/**
 * Base class that represents a query for the 'ОтображаемыеТипыТехникиМТР' table.
 *
 * 
 *
 * @method     ChildОтображаемыетипытехникимтрQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildОтображаемыетипытехникимтрQuery orderByОтображаемыйтиптехники($order = Criteria::ASC) Order by the ОтображаемыйТипТехники column
 *
 * @method     ChildОтображаемыетипытехникимтрQuery groupById() Group by the id column
 * @method     ChildОтображаемыетипытехникимтрQuery groupByОтображаемыйтиптехники() Group by the ОтображаемыйТипТехники column
 *
 ...
 * @method     ChildОтображаемыетипытехникимтр findOneByОтображаемыйтиптехники(string $ОтображаемыйТипТехники) Return the first ChildОтображаемыетипытехникимтр filtered by the ОтображаемыйТипТехники column *
 ...
 * @method     ChildОтображаемыетипытехникимтр requireOneByОтображаемыйтиптехники(string $ОтображаемыйТипТехники) Return the first ChildОтображаемыетипытехникимтр filtered by the ОтображаемыйТипТехники column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildОтображаемыетипытехникимтр[]|ObjectCollection findByОтображаемыйтиптехники(string $ОтображаемыйТипТехники) Return ChildОтображаемыетипытехникимтр objects filtered by the ОтображаемыйТипТехники column
...
abstract class ОтображаемыетипытехникимтрQuery extends ModelCriteria
{
     ...
     * Example usage:
     * <code>
     * $query->filterByОтображаемыйтиптехники('fooValue');   // WHERE ОтображаемыйТипТехники = 'fooValue'
     * $query->filterByОтображаемыйтиптехники('%fooValue%'); // WHERE ОтображаемыйТипТехники LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByОтображаемыйтиптехники($�тображаемыйтиптехники = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ОтображаемыетипытехникимтрTableMap::COL_ОТОБРАЖАЕМЫЙТИПТЕХНИКИ, $�тображаемыйтиптехники, $comparison);
    }
    ...
    public function prune($�тображаемыетипытехникимтр = null)
    {
        if ($�тображаемыетипытехникимтр) {
            throw new LogicException('Отображаемыетипытехникимтр object has no primary key');
    ...
    /**
     * Deletes all rows from the ОтображаемыеТипыТехникиМТР table.
     *
