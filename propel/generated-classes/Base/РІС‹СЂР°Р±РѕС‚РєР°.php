...
/**
 * Base class that represents a row from the 'Выработка' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class выработка implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\выработкаTableMap';
    ...
    /**
     * The value for the выработка field.
     * 
     * @var        boolean
     */
    protected $выработка;
    ...
    /**
     * @var        Childтипытехникивыработка
     */
    protected $aтипытехникивыработка;
    ...
    /**
     * Initializes internal state of Base\выработка object.
     */
    ...
    /**
     * Compares this with another <code>выработка</code> instance.  If
     * <code>obj</code> is an instance of <code>выработка</code>, delegates to
     * <code>equals(выработка)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|выработка The current object, for fluid interface
     */
    ...
    /**
     * Get the [выработка] column value.
     * 
     * @return boolean
     */
    public function getвыработка()
    {
        return $this->выработка;
    }
     ...
     * @return boolean
     */
    public function isвыработка()
    {
        return $this->getвыработка();
    }
     ...
     * @return $this|\выработка The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[выработкаTableMap::COL_ID] = true;
        }
    ...
    public function setдата($v)
    {
        ...
        if ($this->дата !== null || $dt !== null) {
            if ($this->дата === null || $dt === null || $dt->format("Y-m-d") !== $this->дата->format("Y-m-d")) {
                ...
                $this->modifiedColumns[выработкаTableMap::COL_ДАТА] = true;
            }
    ...
    public function setучастокработ($v)
    {
        ...
        if ($this->участок_работ !== $v) {
            ...
            $this->modifiedColumns[выработкаTableMap::COL_УЧАСТОК_РАБОТ] = true;
        }
    ...
    public function setтиптехники($v)
    {
        ...
        if ($this->тип_техники !== $v) {
            $this->тип_техники = $v;
            $this->modifiedColumns[выработкаTableMap::COL_ТИП_ТЕХНИКИ] = true;
        }

        if ($this->aтипытехникивыработка !== null && $this->aтипытехникивыработка->getId() !== $v) {
            $this->aтипытехникивыработка = null;
        }
    ...
    public function setплан($v)
    {
        ...
        if ($this->план !== $v) {
            $this->план = $v;
            $this->modifiedColumns[выработкаTableMap::COL_ПЛАН] = true;
        }
    ...
    public function setфакт($v)
    {
        ...
        if ($this->факт !== $v) {
            $this->факт = $v;
            $this->modifiedColumns[выработкаTableMap::COL_ФАКТ] = true;
        }
    ...
    public function setтипработ($v)
    {
        ...
        if ($this->тип_работ !== $v) {
            $this->тип_работ = $v;
            $this->modifiedColumns[выработкаTableMap::COL_ТИП_РАБОТ] = true;
        }
    ...
    /**
     * Sets the value of the [выработка] column.
     ...
     * @return $this|\выработка The current object (for fluent API support)
     */
    public function setвыработка($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->выработка !== $v) {
            $this->выработка = $v;
            $this->modifiedColumns[выработкаTableMap::COL_ВЫРАБОТКА] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : выработкаTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : выработкаTableMap::translateFieldName('дата', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->дата = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : выработкаTableMap::translateFieldName('участокработ', TableMap::TYPE_PHPNAME, $indexType)];
            $this->участок_работ = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : выработкаTableMap::translateFieldName('типтехники', TableMap::TYPE_PHPNAME, $indexType)];
            $this->тип_техники = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : выработкаTableMap::translateFieldName('план', TableMap::TYPE_PHPNAME, $indexType)];
            $this->план = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : выработкаTableMap::translateFieldName('факт', TableMap::TYPE_PHPNAME, $indexType)];
            $this->факт = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : выработкаTableMap::translateFieldName('типработ', TableMap::TYPE_PHPNAME, $indexType)];
            $this->тип_работ = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : выработкаTableMap::translateFieldName('выработка', TableMap::TYPE_PHPNAME, $indexType)];
            $this->выработка = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = выработкаTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\выработка'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aтипытехникивыработка !== null && $this->тип_техники !== $this->aтипытехникивыработка->getId()) {
            $this->aтипытехникивыработка = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildвыработкаQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see выработка::setDeleted()
     * @see выработка::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildвыработкаQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                выработкаTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aтипытехникивыработка !== null) {
                if ($this->aтипытехникивыработка->isModified() || $this->aтипытехникивыработка->isNew()) {
                    $affectedRows += $this->aтипытехникивыработка->save($con);
                }
                $this->setтипытехникивыработка($this->aтипытехникивыработка);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(выработкаTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ДАТА)) {
            $modifiedColumns[':p' . $index++]  = 'Дата';
        }
        if ($this->isColumnModified(выработкаTableMap::COL_УЧАСТОК_РАБОТ)) {
            $modifiedColumns[':p' . $index++]  = 'Участок_работ';
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ТИП_ТЕХНИКИ)) {
            $modifiedColumns[':p' . $index++]  = 'Тип_техники';
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ПЛАН)) {
            $modifiedColumns[':p' . $index++]  = 'План';
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ФАКТ)) {
            $modifiedColumns[':p' . $index++]  = 'Факт';
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ТИП_РАБОТ)) {
            $modifiedColumns[':p' . $index++]  = 'Тип_работ';
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ВЫРАБОТКА)) {
            $modifiedColumns[':p' . $index++]  = 'Выработка';
        }

        $sql = sprintf(
            'INSERT INTO Выработка (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'Тип_работ':                        
                        ...
                        break;
                    case 'Выработка':
                        $stmt->bindValue($identifier, (int) $this->выработка, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = выработкаTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['выработка'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['выработка'][$this->hashCode()] = true;
        $keys = выработкаTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getдата(),
            $keys[2] => $this->getучастокработ(),
            $keys[3] => $this->getтиптехники(),
            $keys[4] => $this->getплан(),
            $keys[5] => $this->getфакт(),
            $keys[6] => $this->getтипработ(),
            $keys[7] => $this->getвыработка(),
        );
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aтипытехникивыработка) {
                ...
                switch ($keyType) {
                    case TableMap::TYPE_CAMELNAME:
                        $key = '�ипытехникивыработка';
                        break;
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'Типы_техники_выработка';
                        break;
                    default:
                        $key = 'типытехникивыработка';
                }
        
                $result[$key] = $this->aтипытехникивыработка->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setтипработ($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setвыработка($arr[$keys[7]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(выработкаTableMap::COL_ID)) {
            $criteria->add(выработкаTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ДАТА)) {
            $criteria->add(выработкаTableMap::COL_ДАТА, $this->дата);
        }
        if ($this->isColumnModified(выработкаTableMap::COL_УЧАСТОК_РАБОТ)) {
            $criteria->add(выработкаTableMap::COL_УЧАСТОК_РАБОТ, $this->участок_работ);
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ТИП_ТЕХНИКИ)) {
            $criteria->add(выработкаTableMap::COL_ТИП_ТЕХНИКИ, $this->тип_техники);
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ПЛАН)) {
            $criteria->add(выработкаTableMap::COL_ПЛАН, $this->план);
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ФАКТ)) {
            $criteria->add(выработкаTableMap::COL_ФАКТ, $this->факт);
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ТИП_РАБОТ)) {
            $criteria->add(выработкаTableMap::COL_ТИП_РАБОТ, $this->тип_работ);
        }
        if ($this->isColumnModified(выработкаTableMap::COL_ВЫРАБОТКА)) {
            $criteria->add(выработкаTableMap::COL_ВЫРАБОТКА, $this->выработка);
        }
    ...
    {
        $criteria = ChildвыработкаQuery::create();
        $criteria->add(выработкаTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \выработка (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setвыработка($this->getвыработка());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \выработка Clone of current object.
     * @throws PropelException
     */
    ...
    public function getКалендарь(ConnectionInterface $con = null)
    {
        if ($this->aКалендарь === null && (($this->дата !== "" && $this->дата !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aКалендарь->addвыработкаs($this);
             */
        }
    ...
    public function getтипыработ(ConnectionInterface $con = null)
    {
        if ($this->aтипыработ === null && ($this->тип_работ !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aтипыработ->addвыработкаs($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a Childтипытехникивыработка object.
     *
     * @param  Childтипытехникивыработка $v
     * @return $this|\выработка The current object (for fluent API support)
     * @throws PropelException
     */
    public function setтипытехникивыработка(Childтипытехникивыработка $v = null)
    {
        if ($v === null) {
        ...
        $this->aтипытехникивыработка = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Childтипытехникивыработка object, it will not be re-added.
        if ($v !== null) {
            $v->addвыработка($this);
        }
    ...
    /**
     * Get the associated Childтипытехникивыработка object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return Childтипытехникивыработка The associated Childтипытехникивыработка object.
     * @throws PropelException
     */
    public function getтипытехникивыработка(ConnectionInterface $con = null)
    {
        if ($this->aтипытехникивыработка === null && ($this->тип_техники !== null)) {
            $this->aтипытехникивыработка = ChildтипытехникивыработкаQuery::create()->findPk($this->тип_техники, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aтипытехникивыработка->addвыработкаs($this);
             */
        }

        return $this->aтипытехникивыработка;
    }
    ...
    public function getучасткиработ(ConnectionInterface $con = null)
    {
        if ($this->aучасткиработ === null && ($this->участок_работ !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aучасткиработ->addвыработкаs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(выработкаTableMap::DEFAULT_STRING_FORMAT);
    }
