...
/**
 * Base class that represents a row from the 'ДатыОбновленийДашбордов' table.
 *
 * 
 *
...
abstract class Датыобновленийдашбордов implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the дашборд field.
     * 
     * @var        string
     */
    protected $дашборд;
    ...
    /**
     * Set the value of [дашборд] column.
     * 
    ...
    public function setДашборд($v)
    {
        ...
        if ($this->дашборд !== $v) {
            $this->дашборд = $v;
            $this->modifiedColumns[ДатыобновленийдашбордовTableMap::COL_ДАШБОРД] = true;
        }
    ...
    public function setПроект($v)
    {
        ...
        if ($this->проект !== $v) {
            $this->проект = $v;
            $this->modifiedColumns[ДатыобновленийдашбордовTableMap::COL_ПРОЕКТ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->дашборд = (null !== $col) ? (string) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ДатыобновленийдашбордовTableMap::COL_ДАШБОРД)) {
            $modifiedColumns[':p' . $index++]  = 'Дашборд';
        }
        if ($this->isColumnModified(ДатыобновленийдашбордовTableMap::COL_ПРОЕКТ)) {
        ...
        $sql = sprintf(
            'INSERT INTO ДатыОбновленийДашбордов (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':                        
                        ...
                        break;
                    case 'Дашборд':                        
                        $stmt->bindValue($identifier, $this->дашборд, PDO::PARAM_STR);
                        break;
                    case 'Проект':                        
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ДатыобновленийдашбордовTableMap::COL_ДАШБОРД)) {
            $criteria->add(ДатыобновленийдашбордовTableMap::COL_ДАШБОРД, $this->дашборд);
        }
        if ($this->isColumnModified(ДатыобновленийдашбордовTableMap::COL_ПРОЕКТ)) {
            $criteria->add(ДатыобновленийдашбордовTableMap::COL_ПРОЕКТ, $this->проект);
        }
        if ($this->isColumnModified(ДатыобновленийдашбордовTableMap::COL_ДАТА)) {
            $criteria->add(ДатыобновленийдашбордовTableMap::COL_ДАТА, $this->дата);
        }
