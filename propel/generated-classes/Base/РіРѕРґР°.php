...
/**
 * Base class that represents a row from the 'Года' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class года implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\годаTableMap';
    ...
    /**
     * Initializes internal state of Base\года object.
     */
    ...
    /**
     * Compares this with another <code>года</code> instance.  If
     * <code>obj</code> is an instance of <code>года</code>, delegates to
     * <code>equals(года)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|года The current object, for fluid interface
     */
     ...
     * @return $this|\года The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[годаTableMap::COL_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : годаTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 1; // 1 = годаTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\года'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildгодаQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildгодаQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                годаTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[годаTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . годаTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(годаTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }

        $sql = sprintf(
            'INSERT INTO Года (%s) VALUES (%s)',
    ...
    {
        $pos = годаTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['года'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['года'][$this->hashCode()] = true;
        $keys = годаTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        );
    ...
    {
        $criteria = new Criteria(годаTableMap::DATABASE_NAME);

        if ($this->isColumnModified(годаTableMap::COL_ID)) {
            $criteria->add(годаTableMap::COL_ID, $this->id);
        }
    ...
    {
        $criteria = ChildгодаQuery::create();
        $criteria->add(годаTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \года (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \года Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Childгода is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|Childгода The current object (for fluent API support)
     */
     ...
     * Otherwise if this года is new, it will return
     * an empty collection; or if this года has previously
     * been saved, it will retrieve related Календарьs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in года.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function setмобилизацияпомесяцамs(Collection $�обилизацияпомесяцамs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�обилизацияпомесяцамsToDelete as $�обилизацияпомесяцамRemoved) {
            $�обилизацияпомесяцамRemoved->setгода(null);
        }
    ...
    protected function doAddмобилизацияпомесяцам(Childмобилизацияпомесяцам $�обилизацияпомесяцам)
    {
        ...
        $�обилизацияпомесяцам->setгода($this);
    }
    ...
    public function removeмобилизацияпомесяцам(Childмобилизацияпомесяцам $�обилизацияпомесяцам)
    {
        if ($this->getмобилизацияпомесяцамs()->contains($�обилизацияпомесяцам)) {
            ...
            $�обилизацияпомесяцам->setгода(null);
        }
    ...
    public function setпроизводственныепрограммыs(Collection $�роизводственныепрограммыs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�роизводственныепрограммыsToDelete as $�роизводственныепрограммыRemoved) {
            $�роизводственныепрограммыRemoved->setгода(null);
        }
    ...
    protected function doAddпроизводственныепрограммы(Childпроизводственныепрограммы $�роизводственныепрограммы)
    {
        ...
        $�роизводственныепрограммы->setгода($this);
    }
    ...
    public function removeпроизводственныепрограммы(Childпроизводственныепрограммы $�роизводственныепрограммы)
    {
        if ($this->getпроизводственныепрограммыs()->contains($�роизводственныепрограммы)) {
            ...
            $�роизводственныепрограммы->setгода(null);
        }
    ...
    {
        return (string) $this->exportTo(годаTableMap::DEFAULT_STRING_FORMAT);
    }
