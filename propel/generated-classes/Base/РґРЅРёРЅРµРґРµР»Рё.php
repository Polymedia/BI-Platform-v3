...
/**
 * Base class that represents a row from the 'Дни_недели' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class днинедели implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\днинеделиTableMap';
    ...
    /**
     * Initializes internal state of Base\днинедели object.
     */
    ...
    /**
     * Compares this with another <code>днинедели</code> instance.  If
     * <code>obj</code> is an instance of <code>днинедели</code>, delegates to
     * <code>equals(днинедели)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|днинедели The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[днинеделиTableMap::COL_ID] = true;
        }
    ...
    public function setденьнедели($v)
    {
        ...
        if ($this->день_недели !== $v) {
            $this->день_недели = $v;
            $this->modifiedColumns[днинеделиTableMap::COL_ДЕНЬ_НЕДЕЛИ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : днинеделиTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : днинеделиTableMap::translateFieldName('деньнедели', TableMap::TYPE_PHPNAME, $indexType)];
            $this->день_недели = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = днинеделиTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\днинедели'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildднинеделиQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see днинедели::setDeleted()
     * @see днинедели::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildднинеделиQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                днинеделиTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(днинеделиTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(днинеделиTableMap::COL_ДЕНЬ_НЕДЕЛИ)) {
            $modifiedColumns[':p' . $index++]  = 'День_недели';
        }

        $sql = sprintf(
            'INSERT INTO Дни_недели (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':                        
                        ...
                        break;
                    case 'День_недели':                        
                        $stmt->bindValue($identifier, $this->день_недели, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = днинеделиTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['днинедели'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['днинедели'][$this->hashCode()] = true;
        $keys = днинеделиTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getденьнедели(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(днинеделиTableMap::COL_ДЕНЬ_НЕДЕЛИ)) {
            $criteria->add(днинеделиTableMap::COL_ДЕНЬ_НЕДЕЛИ, $this->день_недели);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \днинедели (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \днинедели Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Childднинедели is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|Childднинедели The current object (for fluent API support)
     */
    public function setКалендарьs(Collection $�алендарьs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�алендарьsToDelete as $�алендарьRemoved) {
            $�алендарьRemoved->setднинедели(null);
        }
     ...
     * Otherwise if this днинедели is new, it will return
     * an empty collection; or if this днинедели has previously
     * been saved, it will retrieve related Календарьs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in днинедели.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildКалендарь[] List of ChildКалендарь objects
     */
    public function getКалендарьsJoinмесяца(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildКалендарьQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(днинеделиTableMap::DEFAULT_STRING_FORMAT);
    }
