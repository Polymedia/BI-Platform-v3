...
/**
 * Base class that represents a row from the 'МобилизацияПоМесяцам' table.
 *
 * 
 *
...
abstract class Мобилизацияпомесяцам implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the плаоотгрузкаколичество field.
     * 
     * @var        int
     */
    protected $плаоотгрузкаколичество;
    ...
    /**
     * Get the [плаоотгрузкаколичество] column value.
     * 
     * @return int
     */
    public function getПлаоотгрузкаколичество()
    {
        return $this->плаоотгрузкаколичество;
    }
    ...
    public function setТиптехники($v)
    {
        ...
        if ($this->типтехники !== $v) {
            $this->типтехники = $v;
            $this->modifiedColumns[МобилизацияпомесяцамTableMap::COL_ТИПТЕХНИКИ] = true;
        }
    ...
    /**
     * Set the value of [плаоотгрузкаколичество] column.
     * 
     * @param int $v new value
     * @return $this|\Мобилизацияпомесяцам The current object (for fluent API support)
     */
    public function setПлаоотгрузкаколичество($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->плаоотгрузкаколичество !== $v) {
            $this->плаоотгрузкаколичество = $v;
            $this->modifiedColumns[МобилизацияпомесяцамTableMap::COL_ПЛАООТГРУЗКАКОЛИЧЕСТВО] = true;
        }

        return $this;
    } // setПлаоотгрузкаколичество()
    ...
    public function setФактотгрузкаколичество($v)
    {
        ...
        if ($this->фактотгрузкаколичество !== $v) {
            ...
            $this->modifiedColumns[МобилизацияпомесяцамTableMap::COL_ФАКТОТГРУЗКАКОЛИЧЕСТВО] = true;
        }
    ...
    public function setПландоставкаколичество($v)
    {
        ...
        if ($this->пландоставкаколичество !== $v) {
            ...
            $this->modifiedColumns[МобилизацияпомесяцамTableMap::COL_ПЛАНДОСТАВКАКОЛИЧЕСТВО] = true;
        }
    ...
    public function setФактдоставкаколичество($v)
    {
        ...
        if ($this->фактдоставкаколичество !== $v) {
            ...
            $this->modifiedColumns[МобилизацияпомесяцамTableMap::COL_ФАКТДОСТАВКАКОЛИЧЕСТВО] = true;
        }
    ...
    public function setДатаотчёта($v)
    {
        ...
        if ($this->датаотчёта !== null || $dt !== null) {
            if ($this->датаотчёта === null || $dt === null || $dt->format("Y-m-d") !== $this->датаотчёта->format("Y-m-d")) {
                ...
                $this->modifiedColumns[МобилизацияпомесяцамTableMap::COL_ДАТАОТЧЁТА] = true;
            }
    ...
    public function setУчастокработ($v)
    {
        ...
        if ($this->участокработ !== $v) {
            $this->участокработ = $v;
            $this->modifiedColumns[МобилизацияпомесяцамTableMap::COL_УЧАСТОКРАБОТ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : МобилизацияпомесяцамTableMap::translateFieldName('Плаоотгрузкаколичество', TableMap::TYPE_PHPNAME, $indexType)];
            $this->плаоотгрузкаколичество = (null !== $col) ? (int) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ТИПТЕХНИКИ)) {
            $modifiedColumns[':p' . $index++]  = 'ТипТехники';
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ПЛАООТГРУЗКАКОЛИЧЕСТВО)) {
            $modifiedColumns[':p' . $index++]  = 'ПлаОотгрузкаКоличество';
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ФАКТОТГРУЗКАКОЛИЧЕСТВО)) {
            $modifiedColumns[':p' . $index++]  = 'ФактОтгрузкаКоличество';
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ПЛАНДОСТАВКАКОЛИЧЕСТВО)) {
            $modifiedColumns[':p' . $index++]  = 'ПланДоставкаКоличество';
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ФАКТДОСТАВКАКОЛИЧЕСТВО)) {
        ...
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ДАТАОТЧЁТА)) {
            $modifiedColumns[':p' . $index++]  = 'ДатаОтчёта';
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_УЧАСТОКРАБОТ)) {
            $modifiedColumns[':p' . $index++]  = 'УчастокРабот';
        }

        $sql = sprintf(
            'INSERT INTO МобилизацияПоМесяцам (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'ТипТехники':                        
                        ...
                        break;
                    case 'ПлаОотгрузкаКоличество':                        
                        $stmt->bindValue($identifier, $this->плаоотгрузкаколичество, PDO::PARAM_INT);
                        break;
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getПлаоотгрузкаколичество();
                break;
            case 3:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getПлаоотгрузкаколичество(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setПлаоотгрузкаколичество($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setПлаоотгрузкаколичество($arr[$keys[2]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ТИПТЕХНИКИ)) {
            $criteria->add(МобилизацияпомесяцамTableMap::COL_ТИПТЕХНИКИ, $this->типтехники);
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ПЛАООТГРУЗКАКОЛИЧЕСТВО)) {
            $criteria->add(МобилизацияпомесяцамTableMap::COL_ПЛАООТГРУЗКАКОЛИЧЕСТВО, $this->плаоотгрузкаколичество);
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ФАКТОТГРУЗКАКОЛИЧЕСТВО)) {
            $criteria->add(МобилизацияпомесяцамTableMap::COL_ФАКТОТГРУЗКАКОЛИЧЕСТВО, $this->фактотгрузкаколичество);
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ПЛАНДОСТАВКАКОЛИЧЕСТВО)) {
            $criteria->add(МобилизацияпомесяцамTableMap::COL_ПЛАНДОСТАВКАКОЛИЧЕСТВО, $this->пландоставкаколичество);
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ФАКТДОСТАВКАКОЛИЧЕСТВО)) {
            $criteria->add(МобилизацияпомесяцамTableMap::COL_ФАКТДОСТАВКАКОЛИЧЕСТВО, $this->фактдоставкаколичество);
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ПРОЕКТ)) {
        ...
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_ДАТАОТЧЁТА)) {
            $criteria->add(МобилизацияпомесяцамTableMap::COL_ДАТАОТЧЁТА, $this->датаотчёта);
        }
        if ($this->isColumnModified(МобилизацияпомесяцамTableMap::COL_УЧАСТОКРАБОТ)) {
            $criteria->add(МобилизацияпомесяцамTableMap::COL_УЧАСТОКРАБОТ, $this->участокработ);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setПлаоотгрузкаколичество($this->getПлаоотгрузкаколичество());
    ...
    public function clear()
    {
        ...
        $this->плаоотгрузкаколичество = null;
