...
/**
 * Base class that represents a query for the 'Контролирующие_органы' table.
 *
 * 
 *
 * @method     ChildКонтролирующиеОрганыQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildКонтролирующиеОрганыQuery orderByконтролирующийорган($order = Criteria::ASC) Order by the Контролирующий_орган column
 *
 * @method     ChildКонтролирующиеОрганыQuery groupById() Group by the id column
 * @method     ChildКонтролирующиеОрганыQuery groupByконтролирующийорган() Group by the Контролирующий_орган column
 *
 ...
 *
 * @method     ChildКонтролирующиеОрганыQuery leftJoinПредписания($relationAlias = null) Adds a LEFT JOIN clause to the query using the Предписания relation
 * @method     ChildКонтролирующиеОрганыQuery rightJoinПредписания($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Предписания relation
 * @method     ChildКонтролирующиеОрганыQuery innerJoinПредписания($relationAlias = null) Adds a INNER JOIN clause to the query using the Предписания relation
 *
 * @method     ChildКонтролирующиеОрганыQuery joinWithПредписания($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Предписания relation
 *
 * @method     ChildКонтролирующиеОрганыQuery leftJoinWithПредписания() Adds a LEFT JOIN clause and with to the query using the Предписания relation
 * @method     ChildКонтролирующиеОрганыQuery rightJoinWithПредписания() Adds a RIGHT JOIN clause and with to the query using the Предписания relation
 * @method     ChildКонтролирующиеОрганыQuery innerJoinWithПредписания() Adds a INNER JOIN clause and with to the query using the Предписания relation
 *
 ...
 * @method     ChildКонтролирующиеОрганы findOneByконтролирующийорган(string $Контролирующий_орган) Return the first ChildКонтролирующиеОрганы filtered by the Контролирующий_орган column *
 ...
 * @method     ChildКонтролирующиеОрганы requireOneByконтролирующийорган(string $Контролирующий_орган) Return the first ChildКонтролирующиеОрганы filtered by the Контролирующий_орган column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildКонтролирующиеОрганы[]|ObjectCollection findByконтролирующийорган(string $Контролирующий_орган) Return ChildКонтролирующиеОрганы objects filtered by the Контролирующий_орган column
...
abstract class КонтролирующиеОрганыQuery extends ModelCriteria
{
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = КонтролирующиеОрганыTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
            // the object is already in the instance pool
            return $obj;
        }
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(КонтролирующиеОрганыTableMap::DATABASE_NAME);
        }
     ...
     *
     * @return ChildКонтролирующиеОрганы A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        $sql = 'SELECT id, Контролирующий_орган FROM Контролирующие_органы WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildКонтролирующиеОрганы $obj */
            $obj = new ChildКонтролирующиеОрганы();
            $obj->hydrate($row);
            КонтролирующиеОрганыTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(КонтролирующиеОрганыTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(КонтролирующиеОрганыTableMap::COL_ID, $keys, Criteria::IN);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByконтролирующийорган('fooValue');   // WHERE Контролирующий_орган = 'fooValue'
     * $query->filterByконтролирующийорган('%fooValue%'); // WHERE Контролирующий_орган LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByконтролирующийорган($�онтролирующийорган = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(КонтролирующиеОрганыTableMap::COL_КОНТРОЛИРУЮЩИЙ_ОРГАН, $�онтролирующийорган, $comparison);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildКонтролирующиеОрганыQuery The current query, for fluid interface
     */
    public function filterByПредписания($�редписания, $comparison = null)
    {
        if ($�редписания instanceof \Предписания) {
            return $this
                ->addUsingAlias(КонтролирующиеОрганыTableMap::COL_ID, $�редписания->getконтролирующийорган(), $comparison);
    ...
    public function prune($�онтролирующиеОрганы = null)
    {
        if ($�онтролирующиеОрганы) {
            $this->addUsingAlias(КонтролирующиеОрганыTableMap::COL_ID, $�онтролирующиеОрганы->getId(), Criteria::NOT_EQUAL);
        }
