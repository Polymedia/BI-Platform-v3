...
/**
 * Base class that represents a row from the 'Участки_работ' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class участкиработ implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\участкиработTableMap';
    ...
    /**
     * Initializes internal state of Base\участкиработ object.
     */
    ...
    /**
     * Compares this with another <code>участкиработ</code> instance.  If
     * <code>obj</code> is an instance of <code>участкиработ</code>, delegates to
     * <code>equals(участкиработ)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|участкиработ The current object, for fluid interface
     */
     ...
     * @return $this|\участкиработ The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[участкиработTableMap::COL_ID] = true;
        }
    ...
    public function setучастокработ($v)
    {
        ...
        if ($this->участок_работ !== $v) {
            ...
            $this->modifiedColumns[участкиработTableMap::COL_УЧАСТОК_РАБОТ] = true;
        }
    ...
    public function setпроект($v)
    {
        ...
        if ($this->проект !== $v) {
            $this->проект = $v;
            $this->modifiedColumns[участкиработTableMap::COL_ПРОЕКТ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : участкиработTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : участкиработTableMap::translateFieldName('участокработ', TableMap::TYPE_PHPNAME, $indexType)];
            $this->участок_работ = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : участкиработTableMap::translateFieldName('проект', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = участкиработTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\участкиработ'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildучасткиработQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see участкиработ::setDeleted()
     * @see участкиработ::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildучасткиработQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                участкиработTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(участкиработTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(участкиработTableMap::COL_УЧАСТОК_РАБОТ)) {
            $modifiedColumns[':p' . $index++]  = 'Участок_работ';
        }
        if ($this->isColumnModified(участкиработTableMap::COL_ПРОЕКТ)) {
            $modifiedColumns[':p' . $index++]  = 'Проект';
        }

        $sql = sprintf(
            'INSERT INTO Участки_работ (%s) VALUES (%s)',
    ...
    {
        $pos = участкиработTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(участкиработTableMap::COL_ID)) {
            $criteria->add(участкиработTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(участкиработTableMap::COL_УЧАСТОК_РАБОТ)) {
            $criteria->add(участкиработTableMap::COL_УЧАСТОК_РАБОТ, $this->участок_работ);
        }
        if ($this->isColumnModified(участкиработTableMap::COL_ПРОЕКТ)) {
            $criteria->add(участкиработTableMap::COL_ПРОЕКТ, $this->проект);
        }
    ...
    {
        $criteria = ChildучасткиработQuery::create();
        $criteria->add(участкиработTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \участкиработ (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \участкиработ Clone of current object.
     * @throws PropelException
     */
    ...
    public function getПроекты(ConnectionInterface $con = null)
    {
        if ($this->aПроекты === null && ($this->проект !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aПроекты->addучасткиработs($this);
             */
        }
     ...
     * If this Childучасткиработ is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|Childучасткиработ The current object (for fluent API support)
     */
    public function setвыработкаs(Collection $�ыработкаs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�ыработкаsToDelete as $�ыработкаRemoved) {
            $�ыработкаRemoved->setучасткиработ(null);
        }
     ...
     * Otherwise if this участкиработ is new, it will return
     * an empty collection; or if this участкиработ has previously
     * been saved, it will retrieve related выработкаs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in участкиработ.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function setфизическиеобъёмыs(Collection $�изическиеобъёмыs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�изическиеобъёмыsToDelete as $�изическиеобъёмыRemoved) {
            $�изическиеобъёмыRemoved->setучасткиработ(null);
        }
    ...
    protected function doAddфизическиеобъёмы(Childфизическиеобъёмы $�изическиеобъёмы)
    {
        ...
        $�изическиеобъёмы->setучасткиработ($this);
    }
    ...
    public function removeфизическиеобъёмы(Childфизическиеобъёмы $�изическиеобъёмы)
    {
        if ($this->getфизическиеобъёмыs()->contains($�изическиеобъёмы)) {
            ...
            $�изическиеобъёмы->setучасткиработ(null);
        }
    ...
    {
        return (string) $this->exportTo(участкиработTableMap::DEFAULT_STRING_FORMAT);
    }
