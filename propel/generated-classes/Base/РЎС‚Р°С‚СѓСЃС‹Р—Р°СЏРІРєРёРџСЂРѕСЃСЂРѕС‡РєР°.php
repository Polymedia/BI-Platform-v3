...
/**
 * Base class that represents a row from the 'Статусы_заявки_просрочка' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class СтатусыЗаявкиПросрочка implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\СтатусыЗаявкиПросрочкаTableMap';
    ...
    /**
     * The value for the статус_просрочки field.
     * 
     * @var        string
     */
    protected $статус_просрочки;
    ...
    /**
     * Initializes internal state of Base\СтатусыЗаявкиПросрочка object.
     */
    ...
    /**
     * Compares this with another <code>СтатусыЗаявкиПросрочка</code> instance.  If
     * <code>obj</code> is an instance of <code>СтатусыЗаявкиПросрочка</code>, delegates to
     * <code>equals(СтатусыЗаявкиПросрочка)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|СтатусыЗаявкиПросрочка The current object, for fluid interface
     */
    ...
    /**
     * Get the [статус_просрочки] column value.
     * 
     * @return string
     */
    public function getстатуспросрочки()
    {
        return $this->статус_просрочки;
    }
     ...
     * @return $this|\СтатусыЗаявкиПросрочка The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[СтатусыЗаявкиПросрочкаTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [статус_просрочки] column.
     * 
     * @param string $v new value
     * @return $this|\СтатусыЗаявкиПросрочка The current object (for fluent API support)
     */
    public function setстатуспросрочки($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->статус_просрочки !== $v) {
            $this->статус_просрочки = $v;
            $this->modifiedColumns[СтатусыЗаявкиПросрочкаTableMap::COL_СТАТУС_ПРОСРОЧКИ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : СтатусыЗаявкиПросрочкаTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : СтатусыЗаявкиПросрочкаTableMap::translateFieldName('статуспросрочки', TableMap::TYPE_PHPNAME, $indexType)];
            $this->статус_просрочки = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = СтатусыЗаявкиПросрочкаTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\СтатусыЗаявкиПросрочка'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildСтатусыЗаявкиПросрочкаQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see СтатусыЗаявкиПросрочка::setDeleted()
     * @see СтатусыЗаявкиПросрочка::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildСтатусыЗаявкиПросрочкаQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                СтатусыЗаявкиПросрочкаTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->�редписанияsScheduledForDeletion !== null) {
                if (!$this->�редписанияsScheduledForDeletion->isEmpty()) {
                    foreach ($this->�редписанияsScheduledForDeletion as $�редписания) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[СтатусыЗаявкиПросрочкаTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . СтатусыЗаявкиПросрочкаTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(СтатусыЗаявкиПросрочкаTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(СтатусыЗаявкиПросрочкаTableMap::COL_СТАТУС_ПРОСРОЧКИ)) {
            $modifiedColumns[':p' . $index++]  = 'Статус_просрочки';
        }

        $sql = sprintf(
            'INSERT INTO Статусы_заявки_просрочка (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':                        
                        ...
                        break;
                    case 'Статус_просрочки':                        
                        $stmt->bindValue($identifier, $this->статус_просрочки, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = СтатусыЗаявкиПросрочкаTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getстатуспросрочки();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['СтатусыЗаявкиПросрочка'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['СтатусыЗаявкиПросрочка'][$this->hashCode()] = true;
        $keys = СтатусыЗаявкиПросрочкаTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getстатуспросрочки(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\СтатусыЗаявкиПросрочка
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setстатуспросрочки($arr[$keys[1]]);
        }
    }
    ...
    {
        $criteria = new Criteria(СтатусыЗаявкиПросрочкаTableMap::DATABASE_NAME);

        if ($this->isColumnModified(СтатусыЗаявкиПросрочкаTableMap::COL_ID)) {
            $criteria->add(СтатусыЗаявкиПросрочкаTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(СтатусыЗаявкиПросрочкаTableMap::COL_СТАТУС_ПРОСРОЧКИ)) {
            $criteria->add(СтатусыЗаявкиПросрочкаTableMap::COL_СТАТУС_ПРОСРОЧКИ, $this->статус_просрочки);
        }
    ...
    {
        $criteria = ChildСтатусыЗаявкиПросрочкаQuery::create();
        $criteria->add(СтатусыЗаявкиПросрочкаTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \СтатусыЗаявкиПросрочка (or compatible) type.
    ...
    {
        $copyObj->setстатуспросрочки($this->getстатуспросрочки());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \СтатусыЗаявкиПросрочка Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildСтатусыЗаявкиПросрочка is new, it will return
        ...
        if (null === $this->collПредписанияs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collПредписанияs) {
                ...
                $collПредписанияs = ChildПредписанияQuery::create(null, $criteria)
                    ->filterByСтатусыЗаявкиПросрочка($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildСтатусыЗаявкиПросрочка The current object (for fluent API support)
     */
    public function setПредписанияs(Collection $�редписанияs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�редписанияsToDelete as $�редписанияRemoved) {
            $�редписанияRemoved->setСтатусыЗаявкиПросрочка(null);
        }
    ...
    protected function doAddПредписания(ChildПредписания $�редписания)
    {
        ...
        $�редписания->setСтатусыЗаявкиПросрочка($this);
    }
    ...
    public function removeПредписания(ChildПредписания $�редписания)
    {
        if ($this->getПредписанияs()->contains($�редписания)) {
            ...
            $this->�редписанияsScheduledForDeletion[]= $�редписания;
            $�редписания->setСтатусыЗаявкиПросрочка(null);
        }
     ...
     * Otherwise if this СтатусыЗаявкиПросрочка is new, it will return
     * an empty collection; or if this СтатусыЗаявкиПросрочка has previously
     * been saved, it will retrieve related Предписанияs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in СтатусыЗаявкиПросрочка.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildПредписания[] List of ChildПредписания objects
     */
    public function getПредписанияsJoinПроекты(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildПредписанияQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(СтатусыЗаявкиПросрочкаTableMap::DEFAULT_STRING_FORMAT);
    }
