...
/**
 * Base class that represents a row from the 'Статус_состояния_техники' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class статуссостояниятехники implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\статуссостояниятехникиTableMap';
    ...
    /**
     * Initializes internal state of Base\статуссостояниятехники object.
     */
    ...
    /**
     * Compares this with another <code>статуссостояниятехники</code> instance.  If
     * <code>obj</code> is an instance of <code>статуссостояниятехники</code>, delegates to
     * <code>equals(статуссостояниятехники)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|статуссостояниятехники The current object, for fluid interface
     */
     ...
     * @return $this|\статуссостояниятехники The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[статуссостояниятехникиTableMap::COL_ID] = true;
        }
    ...
    public function setстатус($v)
    {
        ...
        if ($this->статус !== $v) {
            $this->статус = $v;
            $this->modifiedColumns[статуссостояниятехникиTableMap::COL_СТАТУС] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : статуссостояниятехникиTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : статуссостояниятехникиTableMap::translateFieldName('статус', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = статуссостояниятехникиTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\статуссостояниятехники'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildстатуссостояниятехникиQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see статуссостояниятехники::setDeleted()
     * @see статуссостояниятехники::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildстатуссостояниятехникиQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                статуссостояниятехникиTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(статуссостояниятехникиTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(статуссостояниятехникиTableMap::COL_СТАТУС)) {
            $modifiedColumns[':p' . $index++]  = 'Статус';
        }

        $sql = sprintf(
            'INSERT INTO Статус_состояния_техники (%s) VALUES (%s)',
    ...
    {
        $pos = статуссостояниятехникиTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['статуссостояниятехники'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['статуссостояниятехники'][$this->hashCode()] = true;
        $keys = статуссостояниятехникиTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getстатус(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\статуссостояниятехники
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(статуссостояниятехникиTableMap::COL_ID)) {
            $criteria->add(статуссостояниятехникиTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(статуссостояниятехникиTableMap::COL_СТАТУС)) {
            $criteria->add(статуссостояниятехникиTableMap::COL_СТАТУС, $this->статус);
        }
    ...
    {
        $criteria = ChildстатуссостояниятехникиQuery::create();
        $criteria->add(статуссостояниятехникиTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \статуссостояниятехники (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \статуссостояниятехники Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Childстатуссостояниятехники is new, it will return
        ...
        if (null === $this->collмтрs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collмтрs) {
                ...
                $collмтрs = ChildмтрQuery::create(null, $criteria)
                    ->filterByстатуссостояниятехники($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|Childстатуссостояниятехники The current object (for fluent API support)
     */
    public function setмтрs(Collection $�трs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�трsToDelete as $�трRemoved) {
            $�трRemoved->setстатуссостояниятехники(null);
        }
    ...
    public function removeмтр(Childмтр $�тр)
    {
        if ($this->getмтрs()->contains($�тр)) {
            ...
            $�тр->setстатуссостояниятехники(null);
        }
     ...
     * Otherwise if this статуссостояниятехники is new, it will return
     * an empty collection; or if this статуссостояниятехники has previously
     * been saved, it will retrieve related мтрs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in статуссостояниятехники.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(статуссостояниятехникиTableMap::DEFAULT_STRING_FORMAT);
    }
