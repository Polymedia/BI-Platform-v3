...
/**
 * Base class that represents a row from the 'Контролирующие_органы' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class КонтролирующиеОрганы implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\КонтролирующиеОрганыTableMap';
    ...
    /**
     * Initializes internal state of Base\КонтролирующиеОрганы object.
     */
    ...
    /**
     * Compares this with another <code>КонтролирующиеОрганы</code> instance.  If
     * <code>obj</code> is an instance of <code>КонтролирующиеОрганы</code>, delegates to
     * <code>equals(КонтролирующиеОрганы)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|КонтролирующиеОрганы The current object, for fluid interface
     */
     ...
     * @return $this|\КонтролирующиеОрганы The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[КонтролирующиеОрганыTableMap::COL_ID] = true;
        }
    ...
    public function setконтролирующийорган($v)
    {
        ...
        if ($this->контролирующий_орган !== $v) {
            ...
            $this->modifiedColumns[КонтролирующиеОрганыTableMap::COL_КОНТРОЛИРУЮЩИЙ_ОРГАН] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : КонтролирующиеОрганыTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : КонтролирующиеОрганыTableMap::translateFieldName('контролирующийорган', TableMap::TYPE_PHPNAME, $indexType)];
            $this->контролирующий_орган = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = КонтролирующиеОрганыTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\КонтролирующиеОрганы'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildКонтролирующиеОрганыQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see КонтролирующиеОрганы::setDeleted()
     * @see КонтролирующиеОрганы::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildКонтролирующиеОрганыQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                КонтролирующиеОрганыTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(КонтролирующиеОрганыTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(КонтролирующиеОрганыTableMap::COL_КОНТРОЛИРУЮЩИЙ_ОРГАН)) {
            $modifiedColumns[':p' . $index++]  = 'Контролирующий_орган';
        }

        $sql = sprintf(
            'INSERT INTO Контролирующие_органы (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'Контролирующий_орган':                        
                        $stmt->bindValue($identifier, $this->контролирующий_орган, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = КонтролирующиеОрганыTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['КонтролирующиеОрганы'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['КонтролирующиеОрганы'][$this->hashCode()] = true;
        $keys = КонтролирующиеОрганыTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\КонтролирующиеОрганы
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(КонтролирующиеОрганыTableMap::COL_ID)) {
            $criteria->add(КонтролирующиеОрганыTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(КонтролирующиеОрганыTableMap::COL_КОНТРОЛИРУЮЩИЙ_ОРГАН)) {
            $criteria->add(КонтролирующиеОрганыTableMap::COL_КОНТРОЛИРУЮЩИЙ_ОРГАН, $this->контролирующий_орган);
        }
    ...
    {
        $criteria = ChildКонтролирующиеОрганыQuery::create();
        $criteria->add(КонтролирующиеОрганыTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \КонтролирующиеОрганы (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \КонтролирующиеОрганы Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildКонтролирующиеОрганы is new, it will return
        ...
        if (null === $this->collПредписанияs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collПредписанияs) {
                ...
                $collПредписанияs = ChildПредписанияQuery::create(null, $criteria)
                    ->filterByКонтролирующиеОрганы($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildКонтролирующиеОрганы The current object (for fluent API support)
     */
    public function setПредписанияs(Collection $�редписанияs, ConnectionInterface $con = null)
    {
        ...
        foreach ($�редписанияsToDelete as $�редписанияRemoved) {
            $�редписанияRemoved->setКонтролирующиеОрганы(null);
        }
    ...
    protected function doAddПредписания(ChildПредписания $�редписания)
    {
        ...
        $�редписания->setКонтролирующиеОрганы($this);
    }
    ...
    public function removeПредписания(ChildПредписания $�редписания)
    {
        if ($this->getПредписанияs()->contains($�редписания)) {
            ...
            $�редписания->setКонтролирующиеОрганы(null);
        }
     ...
     * Otherwise if this КонтролирующиеОрганы is new, it will return
     * an empty collection; or if this КонтролирующиеОрганы has previously
     * been saved, it will retrieve related Предписанияs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in КонтролирующиеОрганы.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(КонтролирующиеОрганыTableMap::DEFAULT_STRING_FORMAT);
    }
