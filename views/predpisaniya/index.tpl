...
<table>
    <tbody>
    <tr>
        <td style="width: 578px; text-align: right;">Проект</td>
        {*<td style="width: 578px;">{MultipleSelect::widget(['name' => 'filter_project'])}</td>*}
        <td style="width: 578px;">{Select::widget(['name' => 'filter_project'])}</td>
    </tr>
    </tbody>
</table>
        ...
        <td style="width: 556px;">
            <table>
                ...
                <tr style="height: 50px;">
                    <td style="width: 267px; text-align: right;">Подрядчик</td>
    ...
    <tr>
        <td style="width: 556px;">
            <table>
                <tbody>
                <tr style="height: 50px;">
                    <td style="width: 267px; text-align: right;">Замечания</td>
        ...
        <td style="width: 556px;">
            <table width="560">
                ...
                <tr style="height: 13.4688px;">
                    <td style="width: 73px; text-align: right; height: 13.4688px;">Период от</td>
                    <td style="width: 233px; height: 13.4688px;">{Select::widget(['name' => 'filter_datefrom'])}</td>
                    <td style="width: 53px; height: 13.4688px; text-align: right;">до</td>
